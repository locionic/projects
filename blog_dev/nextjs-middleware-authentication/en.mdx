...
date: '2026-08-15'
summary: 'Learn how to secure Next.js App Router applications using Edge Middleware: JWT token verification with jose, role-based routing, and redirect pipelines.'
...
> **Interactive Tool**: Need to quickly inspect, decode, or verify JWT headers, claims, and expiry timestamps in your browser without sending sensitive tokens across the network? Test tokens with our free client-side [JWT Debugger & Token Inspector](/en/tools/jwt-debugger).
