...
<Quiz>
  <QuizQuestion title="What's the first thing you should do before editing Firefox settings?">
    - Change your search engine to DuckDuckGo
    - Back up your Firefox profile
    - Enable HTTPS-only mode
    - Install uBlock Origin
    <QuizQuestion answer="1">Back up your Firefox profile</QuizQuestion>
  </QuizQuestion>
</Quiz>
