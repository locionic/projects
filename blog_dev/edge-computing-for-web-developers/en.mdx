...
tags: ["edge-computing", "performance", "serverless", "web-development", "cloud-computing"]
category: Tech
draft: false
...
<AudioPlayer src="/static/audio/edge-computing-for-web-developers.mp3" title="Executive Audio Briefing" />
...
<Callout type="info" title="Related Posts">
  <ul>
    <li><a href="/en/blog/rest-api-vs-graphql-which-should-you-use">REST API vs GraphQL</a> — API design patterns for modern apps</li>
    <li><a href="/en/blog/nextjs-performance-tips-you-should-know">Next.js Performance Tips</a> — Performance optimization techniques</li>
  </ul>
</Callout>
