...
draft: false
summary: 'We needed more compute for our CI, so we spun up self-hosted runners. Then security audited them. Here is how we locked them down with ARC, network isolation, rootless containers, and OIDC.'
images:
