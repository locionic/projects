...
draft: false
summary: 'Harden self-hosted GitHub Actions runners using Actions Runner Controller (ARC), network isolation, rootless containers, and short-lived OIDC tokens.'
authors: ['default']
category: Tech
---
...
<AudioPlayer src="/static/audio/github-actions-self-hosted-runner-security.mp3" title="Executive Audio Briefing" />
