...
date: 2026-08-28
summary: "Architect resilient event-driven systems using Apache Kafka: master partition keying, consumer group rebalancing, and exactly-once processing semantics."
...
<AudioPlayer src="/static/audio/event-driven-kafka.mp3" title="Executive Audio Briefing" />
