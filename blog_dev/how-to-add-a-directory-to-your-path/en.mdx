---
title: "How to Add a Directory to PATH in Linux (Permanent Fix)"
images: ['https://imgbed.locionic.com/file/1784441548724_how-to-add-a-directory-to-your-path.jpg']
date: '2025-02-13'
...
draft: false
featured: true
summary: "Step-by-step guide to add directories and folders to PATH permanently in Linux & macOS. Edit .bashrc, .zshrc, export commands, and fix command not found."
---
...
<AudioPlayer src="/static/audio/how-to-add-a-directory-to-your-path.mp3" title="Executive Audio Briefing" />
...
<FAQ>
  <Question>How do I permanently add a directory to PATH in Linux?</Question>
  <Answer>
  ...
  <Question>Why does export PATH reset when I close my terminal?</Question>
  <Answer>
  ...
  <Question>Should I put my new directory at the beginning or end of PATH?</Question>
  <Answer>
