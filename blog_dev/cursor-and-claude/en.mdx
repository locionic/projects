...
<Callout type="info" title="AI Tools Series">
  <ul>
    <li><a href="/blog/claude">Getting Started with Claude Code</a> — The official CLI for Claude</li>
    <li><a href="/blog/mcp">Model Context Protocol (MCP) Explained</a> — How AI tools connect to your tools</li>
    <li><a href="/blog/ai-tools">AI Tools I Actually Use</a> — My honest take on the current landscape</li>
  </ul>
</Callout>
