...
date: "2026-07-23"
summary: 'Master production GitHub Actions CI/CD pipelines with reusable workflows, composite actions, matrix builds, OIDC security, and self-hosted runner caching.'
...
<AudioPlayer src="/static/audio/advanced-github-actions-reusable-workflows.mp3" title="Executive Audio Briefing" />
