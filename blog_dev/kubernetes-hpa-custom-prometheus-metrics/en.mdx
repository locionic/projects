...
draft: false
featured: true
summary: 'CPU and memory aren always the best indicators of load. Here is how we configured our kubernetes Horizontal Pod Autoscaler to scale based on actual application traffic using Prometheus.'
images:
