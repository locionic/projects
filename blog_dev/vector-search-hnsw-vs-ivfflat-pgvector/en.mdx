...
date: "2026-09-23"
summary: "Compare HNSW and IVFFlat vector indexing algorithms in pgvector and sqlite-vec. Analyze recall accuracy, build times, memory footprints, and query latency."
tags: ['ai', 'vector-search', 'postgresql', 'databases']
draft: false
featured: true
category: Tech
...
> <audio controls className="w-full mt-2" src="/static/audio/vector-search-hnsw-vs-ivfflat-pgvector.mp3">Your browser does not support the audio element.</audio>
