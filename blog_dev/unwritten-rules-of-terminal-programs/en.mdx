...
images: ['https://imgbed.locionic.com/file/1784441608535_unwritten-rules-of-terminal-programs.jpg']
date: '2024-12-12'
lastUpdated: '2026-07-09'
tags: ["terminal", "shell", "linux", "programming"]
category: Tech
draft: false
...
<AudioPlayer src="/static/audio/unwritten-rules-of-terminal-programs.mp3" title="Executive Audio Briefing" />
...
<Callout type="idea" title="Rule 8: Modern Replacements Follow the Old Rules">
...
<Callout type="info" title="Related Terminal Posts">
  <ul>
    ...
    <li><a href="/en/blog/creating-a-modern-terminal-setup">Creating a Modern Terminal Setup</a> — My current terminal stack</li>
  </ul>
</Callout>
