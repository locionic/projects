...
draft: false
summary: 'Design production Prometheus and Grafana alerts using multi-window multi-burn-rate PromQL rules for service-level objectives (SLOs) and error budgets.'
authors: ['default']
category: Tech
---
...
<AudioPlayer src="/static/audio/prometheus-grafana-alerting-burn-rate-design.mp3" title="Executive Audio Briefing" />
