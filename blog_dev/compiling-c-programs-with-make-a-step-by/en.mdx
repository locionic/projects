...
<Quiz>
<QuizQuestion id="1" question="On Ubuntu/Debian, if configure can't find a library you've installed, what package suffix should you look for?">
Answer: "-dev"
</QuizQuestion>
<QuizQuestion id="2" question="What's the -j flag for in make -j$(nproc)?">
Answer: "Run parallel compilation jobs using all available CPU cores"
</QuizQuestion>
<QuizQuestion id="3" question="Where does Homebrew install libraries on Apple Silicon Macs?">
Answer: "/opt/homebrew/"
</QuizQuestion>
</Quiz>
