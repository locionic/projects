---
title: >-
  Triển khai Zero-Downtime trên Kubernetes: Pod Disruption Budgets, PreStop
  Hooks và Graceful Shutdown
date: '2026-09-23'
summary: >-
  Đạt được triển khai thực sự không gián đoạn (zero-downtime) trên Kubernetes.
  Cấu hình Pod Disruption Budgets, terminationGracePeriodSeconds, preStop hooks
  và cơ chế connection draining của ingress.
tags:
  - kubernetes
  - devops
  - cloud
