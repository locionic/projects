...
<SuccessAlert title="Khởi tạo SaaS với SQLite + Litestream: LiteSaaS">
  Bạn muốn triển khai ngay kiến trúc SQLite WAL + Litestream này vào sản phẩm thực tế? Tham khảo mã nguồn mở **[LiteSaaS trên GitHub](https://github.com/locionic/litesaas)** (kèm [Live Demo](https://litesaas-production.up.railway.app)). Bộ SaaS boilerplate hoàn toàn miễn phí cho Next.js 15, tích hợp sẵn Drizzle ORM, xác thực phiên tự host, và backup Litestream S3 tự động.
</SuccessAlert>
...
Sử dụng bộ cấu hình tương tác dưới đây để tinh chỉnh thiết lập PRAGMA phù hợp với hệ thống của bạn, hoặc sao chép mã nguồn mẫu chuẩn:
...
<SuccessAlert title="Sẵn sàng xây dựng SaaS với SQLite + Litestream?">
  Chúng tôi đã triển khai trọn vẹn kiến trúc này trong **[LiteSaaS](https://github.com/locionic/litesaas)** — bộ khung Next.js 15 SaaS mã nguồn mở hoàn toàn miễn phí. Trải nghiệm ngay [Live Demo](https://litesaas-production.up.railway.app) (có sẵn tài khoản demo đăng nhập tức thì) hoặc clone mã nguồn về để chạy ứng dụng của bạn chỉ với $4/tháng trên bất kỳ VPS nào.
</SuccessAlert>
