...
images:
  - '/static/images/fastapi-vs-celery-background-tasks.png'
...
<AudioPlayer src="/static/audio/fastapi-vs-celery-background-tasks.mp3" title="Executive Audio Briefing" />
...
<InfoAlert title="Master Production Python & Async Architecture">
  Building high-throughput microservices and distributed task pipelines? Level up your engineering with our free, multi-module course: **[Modern Python for Engineers: From Zero to Production](/en/courses/modern-python-course)** covering type systems, async event loops, and high-concurrency patterns.
</InfoAlert>
...
- [SQLite in Production: WAL Mode, High Concurrency, and Battle-Tested PRAGMAs](/en/blog/sqlite-wal-mode-production-concurrency)
