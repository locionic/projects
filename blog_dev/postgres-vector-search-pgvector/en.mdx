...
date: "2026-11-05"
draft: false
summary: 'Build scalable, high-performance semantic search in PostgreSQL using pgvector: HNSW indexing, IVFFlat trade-offs, cosine distance, and hybrid SQL queries.'
images:
...
<AudioPlayer src="/static/audio/postgres-vector-search-pgvector.mp3" title="Executive Audio Briefing" />
